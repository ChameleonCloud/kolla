...
SOURCES = {
    ...
    'congress-base': {
        ...
        'location': ('$tarballs_base/congress/'
                     'openstack-congress-9.0.0.tar.gz')},
    'cloudkitty-base': {
        'type': 'url',
        'location': ('$tarballs_base/cloudkitty/'
                     'cloudkitty-9.0.0.tar.gz')},
    'crane': {
        'type': 'url',
    ...
    'cyborg-base': {
        ...
        'location': ('$tarballs_base/cyborg/'
                     'openstack-cyborg-2.0.0.tar.gz')},
    'designate-base': {
        'type': 'url',
        'location': ('$tarballs_base/designate/'
                     'designate-8.0.0.tar.gz')},
    'dragonflow-base': {
        'type': 'url',
    ...
    'freezer-api': {
        ...
        'location': ('$tarballs_base/freezer-api/'
                     'freezer-api-7.1.0.tar.gz')},
    'freezer-base': {
        'type': 'url',
        'location': ('$tarballs_base/freezer/'
                     'freezer-7.1.0.tar.gz')},
    'glance-base': {
        'type': 'url',
    ...
    'horizon-plugin-octavia-dashboard': {
        ...
        'location': ('$tarballs_base/octavia-dashboard/'
                     'octavia-dashboard-3.0.1.tar.gz')},
    ...
    'horizon-plugin-senlin-dashboard': {
        ...
        'location': ('$tarballs_base/senlin-dashboard/'
                     'senlin-dashboard-0.10.1.tar.gz')},
    ...
    'monasca-notification': {
        ...
        'location': ('$tarballs_base/monasca-notification/'
                     'monasca-notification-1.17.0.tar.gz')},
    'monasca-persister': {
        'type': 'url',
    ...
    'neutron-bgp-dragent': {
        ...
        'location': ('$tarballs_base/neutron-dynamic-routing/'
                     'neutron-dynamic-routing-14.0.0.tar.gz')},
    'neutron-lbaas-agent': {
        'type': 'url',
    ...
    'neutron-server-plugin-networking-infoblox': {
        ...
        'location': ('$tarballs_base/networking-infoblox/'
                     'networking-infoblox-12.0.0.tar.gz')},
    ...
    'tempest-plugin-barbican': {
        ...
        'location': ('$tarballs_base/barbican-tempest-plugin/'
                     'barbican_tempest_plugin-0.2.0.tar.gz')},
    ...
    'tempest-plugin-cinder': {
        ...
        'location': ('$tarballs_base/cinder-tempest-plugin/'
                     'cinder_tempest_plugin-0.2.0.tar.gz')},
    ...
    'tempest-plugin-mistral': {
        ...
        'location': ('$tarballs_base/mistral-tempest-plugin/'
                     'mistral_tempest_tests-0.2.0.tar.gz')},
    ...
    'tempest-plugin-trove': {
        ...
        'location': ('$tarballs_base/trove-tempest-plugin/'
                     'trove_tempest_plugin-0.2.0.tar.gz')},
    'tempest-plugin-vitrage': {
        'type': 'url',
        'location': ('$tarballs_base/vitrage-tempest-plugin/'
                     'vitrage-tempest-plugin-2.2.1.tar.gz')},
    ...
    'sahara-base-plugin-ambari': {
        ...
        'location': ('$tarballs_base/sahara-plugin-ambari/'
                     'sahara-plugin-ambari-1.0.0.tar.gz')},
